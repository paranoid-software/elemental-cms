...
class Remove:
    ...
    def exec(self, name) -> Optional[Tuple]:
        ...
        backup_filepaths = self.build_backup(snippet['_id'])
    ...
    def build_backup(self, _id) -> Optional[Tuple]:
        ...
        spec_backup_file = open(spec_backup_filepath, mode='x', encoding='utf-8')
        ...
        content_backup_file = open(content_backup_filepath, mode='x', encoding='utf-8')
